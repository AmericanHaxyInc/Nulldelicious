...
ndcore.connection.connect(function()
{
    ...
    ndcore.interfaces.SetId('site', siteId, {id : siteId, title : "NewBlog", description : "This is a new blog yo"}, principal)
        ...
        {
            hx$.Log("adding role");
            return ndcore.interfaces.SetId("role", roleId, {id : roleId, siteScoped: false, userScoped: false, name : "Admin", access: [{resource : "user", interfaces : [{name : "user"}, {name : "site"}]}]}, principal);
        }).then(function()
        {
